...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Bulan Mei 2024 pada 07.44
...
--
-- Struktur dari tabel `tbl_dokumen_user`
--
...
--
-- Dumping data untuk tabel `tbl_dokumen_user`
--
...
(153, 'Minahasa', 'IKU 2024', 'IKU', '2024-05-20', '2024', 'Undangan_Kepala_Pusat_Pembinaan,_Pendidikan_dan_Pelatihan_Perencana,_Kementerian PPNBappenas1.pdf', 1, 0, 0, 0);
...
--
-- Struktur dari tabel `tbl_jenis_user`
--
...
--
-- Dumping data untuk tabel `tbl_jenis_user`
--
...
--
-- Struktur dari tabel `tbl_pengukuran_triwulan`
--
...
--
-- Dumping data untuk tabel `tbl_pengukuran_triwulan`
--
...
--
-- Struktur dari tabel `tbl_status_dokumen`
--
...
--
-- Dumping data untuk tabel `tbl_status_dokumen`
--
...
--
-- Struktur dari tabel `tbl_triwulan`
--
...
--
-- Dumping data untuk tabel `tbl_triwulan`
--
...
(23, 'admin', 'admin', 'adm.sakipsulut@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 1, 1, '2022-12-13', '2022-12-17'),
(52, 'Minahasa', 'Organisasi Perangkat Daerah', 'minahasa@gmail.com', '8e4617ef125983a6027ee48bc3ef0351', 2, 1, '2023-04-19', '2024-05-20'),
(53, 'Manado', 'Organisasi Perangkat Daerah', 'manado@gmail.com', '6ad14ba9986e3615423dfca256d04e3f', 2, 1, '2023-04-19', '2023-04-19');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_year`
--
...
--
-- Dumping data untuk tabel `tbl_year`
--
...
--
-- Indeks untuk tabel `tbl_dokumen_user`
--
...
--
-- Indeks untuk tabel `tbl_pengukuran_triwulan`
--
ALTER TABLE `tbl_pengukuran_triwulan`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tbl_status_dokumen`
--
ALTER TABLE `tbl_status_dokumen`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tbl_triwulan`
--
...
--
-- AUTO_INCREMENT untuk tabel `tbl_dokumen_user`
--
ALTER TABLE `tbl_dokumen_user`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_pengukuran_triwulan`
--
ALTER TABLE `tbl_pengukuran_triwulan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT untuk tabel `tbl_status_dokumen`
--
ALTER TABLE `tbl_status_dokumen`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT untuk tabel `tbl_triwulan`
--
ALTER TABLE `tbl_triwulan`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_year`
--
ALTER TABLE `tbl_year`
